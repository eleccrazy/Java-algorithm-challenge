 ...
 * 10 = 1 + 2 + 3+ 4
 * 15 = 1 + 2 + 3 + 4 + 5
 * Note that from the above we can deduce that 7, 8, and 9 are not stacked
 * numbers because they cannot be the sum of any sequence of
 ...
 * int isStacked(int n);
 * So for example, isStacked(10) should return 1 and isStacked(7) should return
 * 0.
 */
...
public class Stacked {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isStacked(18));
    }
}